...
function searchImages(new_search){
	...
	$.ajax({
		...
		url: `https://${localStorage['api']}/Assets/search?Query=${searchField.value}&pageNumber=${api_page_num}&pageSize=${api_page_size}&allContent=undefined`,
		// url: `https://${localStorage['api']}/Assets/search?Query=${searchField.value}&pageNumber=${api_page_num}&pageSize=${api_page_size}&DateRange=[{Start:2020-02-29,End:2020-03-01}]&DateCreatedFilter=true`,
		// url: `https://${localStorage['api']}/Assets/search?Query=${searchField.value}&pageNumber=${api_page_num}&pageSize=${api_page_size}&DateRange=%5B%7BStart:2020-02-29,End:2020-03-01%7D%5D&DateCreatedFilter=true`,
		// url: `https://${localStorage['api']}/Assets/search?Query=${searchField.value}&pageNumber=${api_page_num}&pageSize=${api_page_size}&DateRange=[{Start:2020-02-29,End:2020-03-01}]&DateCreatedFilter=true`,
		// url: `https://${localStorage['api']}/Assets/search?Query=${searchField.value}&pageNumber=${api_page_num}&pageSize=${api_page_size}&DateRange=%5B%7BStart%3A2020-02-29%2CEnd%3A2020-03-01%7D%5D&DateCreatedFilter=true`,
		// url: `https://${localStorage['api']}/Assets/search?Query=${searchField.value}&pageNumber=${api_page_num}&pageSize=${api_page_size}&DateRange=%5B%7BStart:2020-02-29%2CEnd:2020-03-01%7D%5D&DateCreatedFilter=true`,
																																		// {"DateRange":[{"Start":"2020-02-01","End":"2020-02-01"}],"DateCreatedFilter":"true"}
...
function check_length(){
	...
	$('.img_thumb').click(function(){
		...
		$('.img_download').unbind().on('click',()=>{
			...
			ipcRenderer.send('covid19pic',node)
		})
